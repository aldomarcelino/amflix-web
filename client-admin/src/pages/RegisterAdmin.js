  ...
  return (
    <>
      <div className="min-w-screen min-h-screen flex items-center justify-center px-5 py-5">
        <div className="ml-96 text-gray-500 rounded-3xl shadow-xl w-8/12 overflow-hidden">
          <div className="md:flex w-full justify-center">
            <div className="w-full md:w-1/2 py-10 px-5 md:px-10">
              ...
              <div>
                ...
                <div className="flex -mx-3">
                  <div className="w-full px-3 mb-5">
                    <button className="block w-full max-w-xs mx-auto bg-red hover:bg-rose-700 focus:bg-rose-700 text-white rounded-lg px-3 py-3 font-semibold">
                      Sign Up
                    </button>
                  </div>
                </div>
